...
if __name__ == '__main__':
    ...
    vocab_file = '/home/lil/Pycharm/Huawei-Roberta/Roberta-base/vocab.json'
    merges_file = '/home/lil/Pycharm/Huawei-Roberta/Roberta-base/merges.txt'

    tokenizer = RobertaTokenizer(vocab_file = vocab_file, merges_file = merges_file)

    def some_texts():
        filenames = glob.glob('/home/lil/Dataset/BookCorpus/*/*/*')
    ...
    if model == 'roberta':
        ...
        for i in range(10):  # 数据重复10遍
            TD.process(
                ...
                record_name='/home/lil/Pycharm/Huawei-Roberta/test/corpus.%s.tfrecord' % i,
                workers=workers,
                max_queue_size=max_queue_size,
            )
